...
/// ジャンル別の創作スタイル指示文を返す（物語の題材は常に論文内容）
fn tone_instruction(tone: &str) -> &'static str {
    match tone {
        "少年マンガ" => "【ジャンル演出】熱血・友情・努力・成長の文体で描く。台詞は短く感情的に。「諦めるな！」「これが俺たちの答えだ！」のような熱い表現を使う。物語の核心は必ず論文の実際の発見とすること。",
        "SF" => "【ジャンル演出】SF的・宇宙規模の視点で描く。冷静で知的、宇宙の神秘を感じさせるトーン。物語の核心は必ず論文の実際の発見とすること。",
        "社会派" => "【ジャンル演出】社会問題・医療・患者の視点を前面に出す。研究の社会的インパクトを中心に据え、患者・医師・家族の感情を描く。物語の核心は必ず論文の実際の発見とすること。",
        "ホラー" => "【ジャンル演出】論文が発見した異常・制御不能な現象の恐怖を描く。静かで不気味なトーン、日常の中に忍び込む科学的真実の恐怖。物語の核心は必ず論文の実際の発見とすること。",
        "恋愛" => "【ジャンル演出】「本来いるべき場所を離れた逸脱者」を禁じられた恋として描く。甘くせつなく、科学的真実を純愛の比喩で表現する。物語の核心は必ず論文の実際の発見とすること。",
        _ => "【ジャンル演出】客観的かつ分かりやすいポップサイエンスのトーンで描く。専門知識がない読者にも伝わるよう平易に。物語の核心は必ず論文の実際の発見とすること。",
    }
}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
【重要ルール】
1. theme_line・characters・synopsis・panel_beats は全て、下記【論文要約】の実際の研究内容・発見・科学的事実を必ず物語の核心に据えること
2. 論文に書かれていない架空の研究テーマ（例: NLP・量子コンピュータ・ブロックチェーン等）を勝手に作り出すことは禁止
3. キャラクター名は論文の研究対象（酵素・分子・現象等）から発想するとエンタメ性が増す（例: 研究者名・物質名・現象名を名前に取り入れる）。ただし必須ではなく、魅力的なキャラクター名であれば何でも可
4. 指定ジャンルは「物語の語り口・演出ジャンル」のみを規定し、物語の題材は必ず論文の実際の内容とすること
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
